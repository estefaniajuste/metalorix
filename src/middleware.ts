...
const LEARN_SLUG_REDIRECTS: Record<string, { cluster: string; slug: string }> = {
  ...
  "what-are-base-metals": { cluster: "fundamentals", slug: "precious-vs-base-metals" },
  ...
  "how-does-ppi-affect-gold-prices": { cluster: "price-factors", slug: "ppi-and-gold-correlation" },
  ...
  "gold-etf-vs-physical-gold-weighing-your-investment-options": { cluster: "comparisons", slug: "physical-gold-vs-gold-etf" },
  "silver-demonetization-how-silver-lost-its-monetary-role": { cluster: "history", slug: "demonetization-of-silver-1870s" },
  "the-troy-ounce-explained": { cluster: "fundamentals", slug: "troy-ounce-explained" },
  "precious-metals-vs-base-metals": { cluster: "fundamentals", slug: "precious-vs-base-metals" },
  "ppi-and-gold": { cluster: "price-factors", slug: "ppi-and-gold-correlation" },
  "physical-gold-vs-gold-etf-the-complete-comparison": { cluster: "comparisons", slug: "physical-gold-vs-gold-etf" },
};
