...
Return a valid JSON object with this exact schema:
{
  ...
  "seoTitle": "SEO-optimized title (50-60 chars) designed to FORCE a click — the title MUST promise something Google's snippet cannot show (a comparison table, price data, a ranking, a counter-intuitive insight). ANTI-ZERO-CLICK RULE: If Google can answer the query entirely from the title alone, rewrite it. Proven patterns: (1) Tension/surprise: 'Miller Process: Why 99.5% Gold Purity Isn't Good Enough', (2) Comparison with verdict: 'NGC vs PCGS 2026: Fee Table & Which Adds More Resale Value', (3) Data behind a paywall: 'CPI Release Day: How Gold Reacts Within Minutes (Data Since 2020)', (4) Provocative question: 'The 5-10% Gold Rule: Where It Came From and If It Still Works', (5) Personal stakes: 'Which Precious Metal Is Hardest to Sell? Liquidity Ranked by Spread'. NEVER just describe the topic — create an information gap the reader must click to close. NEVER use 'Introduction to', 'Overview of', 'Understanding', or 'Explained' as openers.",
  "metaDescription": "Meta description (140-155 chars) that makes the click irresistible. Start with a concrete, surprising fact or number. Then promise EXCLUSIVE content: a table, chart, ranking, or comparison that Google's snippet cannot replicate. End with a hook. BAD: 'Learn about moving averages in precious metals markets.' GOOD: 'Gold moves 0.5-2% within 30 min of a CPI print. See 6 years of reaction data charted — and the one pattern that predicts direction.'",
