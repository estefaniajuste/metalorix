...
export async function generateMetadata() {
  ...
  return {
    ...
    alternates: { canonical: "https://metalorix.com/noticias" },
  };
}
      ...
      <div className="mx-auto max-w-[1200px] px-6">
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center gap-3 flex-wrap">
            ...
            <Link href="/precio/oro" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-sm text-sm font-semibold bg-surface-1 border border-border text-content-0 hover:border-border-hover transition-all">
              {t("goldPrice")}
            </Link>
          </div>
        </div>
