...
export const alt = "Metalorix — Precios de Oro, Plata y Platino en tiempo real";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Precios spot en tiempo real, gráficos profesionales y analítica para Oro, Plata y Platino
        </div>
